necesitas instalar 3 librerías en tu equipo para poder hacer uso del proyecto, para lo cual necesitas ejecutar estos 3 comandos por separados en una terminal de tu proyecto
primero:
**pip install numpy**
segundo:
**pip install scipy**
